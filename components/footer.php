<footer class="footer">
   ...
   <!-- <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:Cosmoscloth@gmail.com"><i class="fas fa-envelope"></i>Cosmoscloth@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Butwal, Nepal </a>
      </div>
   ...
   <div class="credit"> <span>COSMOS.NP</span> </div>
